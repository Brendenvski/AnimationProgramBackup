...
public class AllModelsForView extends javax.swing.JFrame {
    ...
    //public DeepThoughtModel aDeepThoughtModel = new DeepThoughtModel();
    public PicFile thePicFile;
    public Brush theBrush = new Brush((new Color(0,0,0)), 19);
    public Frames frameInfo = new Frames();
    public PicFile[] framesArray = new PicFile[1000];
    //public PicFile frame0;
    //public PicFile frame1;
}
